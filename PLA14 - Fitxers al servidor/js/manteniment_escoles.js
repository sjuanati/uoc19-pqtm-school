...
window.onload = function() {
  ...
  document.getElementById('alta').addEventListener('click', altaEscola);
...
function altaEscola() {
  ...
  nomEscola = document.getElementById('novaEscola').value;
