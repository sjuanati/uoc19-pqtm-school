...
function obtenirGrups() {
  ...
  .then(function(resultat) {
    ...
    let td = document.querySelectorAll("#profesTaula td")
...
function consultaGrup() {
  ...
  let tr = document.querySelectorAll("#profesTaula tr")
  ...
  .then(function(resultat) {
    ...
    let numParticipants = resultat[0].numparticipantes;
