...
// **** COMPTE! en teoria se li ha de passar l'idProfessor per paràmetre
const obtenirAlumnes = () => {
    ...
    .then(function(resultat) {
        ...
        for (i=0; i<td.length; i++) {
            td[i].onclick = localitzacioAlumne
        }
    })
    .catch(function(error) {
        print(error);
...
function localitzacioAlumne() {
    ...
    var tr = document.querySelectorAll("#llistaAlumnes tr")
